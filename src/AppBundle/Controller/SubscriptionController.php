    ...
    public function api_paypalAction(Request $request,$token)
    {
        ...
        if ($user_obj != null and $pack != null) {
            if (sha1($user_obj->getPassword()) == $key and $user_obj->isEnabled()) {
                ...
                $code=201;
                $message="Obrigado pelo pagamento. Iremos analisar as informações preenchidas e creditar a sua conta.";
                $values=array();
                ...
                */
                ...
                $code = 500;
                $message = "Ocorreu algum erro. Por favor, entre em contato com a nossa equipe de suporte";
            }
        } else {
            $code = 500;
            $message = "Ocorreu algum erro. Por favor, entre em contato com a nossa equipe de suporte";
