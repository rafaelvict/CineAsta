...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'/src/MediaBundle/Entity'), 1 => ($this->targetDirs[3].'/src/AppBundle/Entity'), 2 => ($this->targetDirs[3].'/src/UserBundle/Entity')]);

$b->addDriver($c, 'MediaBundle\\Entity');
...
$a->setEntityNamespaces(['MediaBundle' => 'MediaBundle\\Entity', 'AppBundle' => 'AppBundle\\Entity', 'UserBundle' => 'UserBundle\\Entity']);
...
$a->addCustomStringFunction('SHA1', 'AppBundle\\DQL\\Sha1');
$a->addCustomNumericFunction('Rand', 'AppBundle\\DQL\\Rand');
