...
class Item extends \AppBundle\Entity\Item implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Item' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Item' . "\0" . 'position', '' . "\0" . 'AppBundle\\Entity\\Item' . "\0" . 'poster', '' . "\0" . 'AppBundle\\Entity\\Item' . "\0" . 'channel', '' . "\0" . 'AppBundle\\Entity\\Item' . "\0" . 'user'];
        }
