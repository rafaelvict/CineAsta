 ...
 */
class Season extends \AppBundle\Entity\Season implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Season' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Season' . "\0" . 'title', '' . "\0" . 'AppBundle\\Entity\\Season' . "\0" . 'position', '' . "\0" . 'AppBundle\\Entity\\Season' . "\0" . 'poster', '' . "\0" . 'AppBundle\\Entity\\Season' . "\0" . 'episodes'];
        }
