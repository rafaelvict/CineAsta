...
class Rate extends \AppBundle\Entity\Rate implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Rate' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Rate' . "\0" . 'value', '' . "\0" . 'AppBundle\\Entity\\Rate' . "\0" . 'review', '' . "\0" . 'AppBundle\\Entity\\Rate' . "\0" . 'created', '' . "\0" . 'AppBundle\\Entity\\Rate' . "\0" . 'poster', '' . "\0" . 'AppBundle\\Entity\\Rate' . "\0" . 'channel', '' . "\0" . 'AppBundle\\Entity\\Rate' . "\0" . 'user'];
        }
