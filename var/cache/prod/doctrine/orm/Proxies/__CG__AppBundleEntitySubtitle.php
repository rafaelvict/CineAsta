 ...
 */
class Subtitle extends \AppBundle\Entity\Subtitle implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Subtitle' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Subtitle' . "\0" . 'file', '' . "\0" . 'AppBundle\\Entity\\Subtitle' . "\0" . 'media', '' . "\0" . 'AppBundle\\Entity\\Subtitle' . "\0" . 'poster', '' . "\0" . 'AppBundle\\Entity\\Subtitle' . "\0" . 'episode', '' . "\0" . 'AppBundle\\Entity\\Subtitle' . "\0" . 'language'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Subtitle $proxy) {
