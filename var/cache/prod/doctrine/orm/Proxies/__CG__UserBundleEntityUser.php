...
class User extends \UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'theme', 'type', 'locked', 'expired', 'credentialsExpired', 'token', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'comments', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'subscriptions', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'ratings', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'items', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'media', 'privacypolicy', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'file', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
