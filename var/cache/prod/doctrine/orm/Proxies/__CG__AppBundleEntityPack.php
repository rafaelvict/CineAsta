...
class Pack extends \AppBundle\Entity\Pack implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Pack' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Pack' . "\0" . 'title', '' . "\0" . 'AppBundle\\Entity\\Pack' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Pack' . "\0" . 'discount', '' . "\0" . 'AppBundle\\Entity\\Pack' . "\0" . 'price', '' . "\0" . 'AppBundle\\Entity\\Pack' . "\0" . 'duration'];
        }
